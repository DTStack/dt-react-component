...
export default class Index extends React.Component<any, any> {
    ...
    downloadChrome () {
        ...
        window.open(window.APP_CONF[os], '_blank');
    }
    render () {
        const cls = classNames('chrome-download')
        return (
            <div className={cls} style={{ height: '100%' }}>
                <img src='public/img/pic_update.png' className="pic-update" />
                ...
                <div className="download">
                    <a href="#" onClick={this.downloadChrome.bind(this)}>
                        <img src='public/img/btn_google.svg' />
