...
stories.add('ProgressLine', () => {
    ...
    return (
        <div className='story_wrapper'>
            ...
            <ExampleContainer otherDependencies={otherDependencies} code={code} hasCodeSandBox={true}>
                <div>
                    <div style={wrapperStyle}>
                        ...
                        <ProgressLine needTitle={false} color="#3BCEFF" title="衍生标签" num={20} percent="20%"></ProgressLine>&nbsp;
                    </div>
                    <div style={wrapperStyle}>
                        <div style={labelStyle}>默认使用:</div>
                        <ProgressLine color="#3BCEFF" title="衍生标签" num={20} percent="20%" width="280px"></ProgressLine>&nbsp;
                    </div>
                    <div style={wrapperStyle}>
                        <div style={labelStyle}>修改 title:</div>
                        <ProgressLine color="#3BCEFF" title="原子标签" num={20} percent="20%" width="280px"></ProgressLine>&nbsp;
                    </div>
                    <div style={wrapperStyle}>
                        <div style={labelStyle}>修改 color:</div>
                        <ProgressLine color={defaultStyle} title="原子标签" num={20} percent="20%" width="280px"></ProgressLine>&nbsp;
                    </div>
                    <div style={wrapperStyle}>
                        <div style={labelStyle}>修改 num:</div>
                        <ProgressLine color="#3BCEFF" title="原子标签" num={45} percent="45%" width="280px"></ProgressLine>&nbsp;
                    </div>
                    <div style={wrapperStyle}>
                        <div style={labelStyle}>修改 width:</div>
                        <ProgressLine color="#3BCEFF" title="原子标签" num={20} percent="20%" width="350px"></ProgressLine>&nbsp;
                    </div>
                    <div style={wrapperStyle}>
                        <div style={labelStyle}>修改 percent:</div>
                        <ProgressLine color="#3BCEFF" title="原子标签" num={75} percent="75%" width="280px"></ProgressLine>&nbsp;
                    </div>
                </div>
            </ExampleContainer>
            <p style={{ marginTop: '10px' }}>通过组件的 needTitle 控制进度条描述是否展示</p>
            <div className='strory-code_border'>
                <ProgressLine needTitle={needTitle} color="#3BCEFF" title="衍生标签" num={20} percent="20%"></ProgressLine>
            </div>
            ...
            <div className='strory-code_border'>
                <ProgressLine color={style} title={title} num={num} percent="60%"></ProgressLine>&nbsp;
            </div>
            <p style={{ marginTop: '10px' }}>通过自定义 percent 属性控制百分比</p>
            <div className='strory-code_border'>
                <ProgressLine color={style} title={title} num={num} percent={percent}></ProgressLine>&nbsp;
            </div>
            <p style={{ marginTop: '10px' }}>通过自定义 color 属性控制颜色</p>
            <div className='strory-code_border'>
                <ProgressLine color={style} title="原子标签" num={35} percent="60%"></ProgressLine>&nbsp;
            </div>
            <p style={{ marginTop: '10px' }}>通过自定义 width 属性控制长度</p>
            <div className='strory-code_border'>
                <ProgressLine color={style} title="原子标签" num={35} percent="60%" width={width}></ProgressLine>&nbsp;
            </div>
        </div>
    )
}, {
