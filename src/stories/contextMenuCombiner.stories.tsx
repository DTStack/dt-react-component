...
const renderTitle = text => (
    <ContextMenuCombiner operations={operations(text)} ctxMenuWrapperClsName='tree-wrapper' id={text}>
        <span>{text}</span>
    </ContextMenuCombiner>
)
...
stories.add('ContextMenuCombiner', () => (
    <div className='story_wrapper'>
        ...
        <ExampleContainer otherDependencies={otherDependencies} code={code} hasCodeSandBox={true} functionCode={functionCode}>
            <div style={{ position: 'relative' }}>
                <Tree defaultExpandAll className='tree-wrapper'>
                    <TreeNode key='0-0' style={{ position: 'relative' }} title={renderTitle('0-0')}>
                        <TreeNode key="0-0-0" style={{ position: 'relative' }} title={renderTitle('0-0-0')}/>
                        <TreeNode key="0-0-1" style={{ position: 'relative' }} title={renderTitle('0-0-1')}/>
                    </TreeNode>
                </Tree>
            </div>
        </ExampleContainer>
